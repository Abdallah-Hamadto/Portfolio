...
return (
<nav className='flex flex-col items-conter xl:justify-center gap-y-4 fixed h-max
bottom-0 mt-auto xl:right-[2%] z-50 top-0 w-full xl:w-16 xl:max-w-md xl:h-screen'> 
 {/*inner*/}
    ...
    px-4 md:px-40 xl:px-0 h-[80px] xl:h-max py-8 bg-white/10 backdrop-blure-sm text-3xl 
    al:text-xl xl:rounded-full'>
